...
public class BlockProjectionGemOre extends BlockArcana
{
	...
	int maxVeinSize = 1 + random.nextInt(4); //this means each patch of our blocks will be between 4 and 8 large
	...
	public BlockProjectionGemOre()
	
	{
		super("BlockProjectionGemOre", Material.rock );
		this.setBlockName("BlockProjectionGemOre");
	...
	{
		return ModItems.ItemProjectionGem;
